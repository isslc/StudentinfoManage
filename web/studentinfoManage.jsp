    ...
    <script type="text/javascript">
        ...
        function deleteStudent() {
            ...
            for (var i = 0; i < selectedRows.length; i++) {
                strIds.push(selectedRows[i].stuId);/*获取ID存入数组*/
            }
...
<div id="tb" style="margin-bottom: 5px">
    ...
    <div>
        ...
        &nbsp; <a href="javascript:resettudent()" class="easyui-linkbutton" iconCls="icon-reload" plain="true">重置</a>
    </div>
